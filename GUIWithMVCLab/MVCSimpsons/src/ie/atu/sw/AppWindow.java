...
/*
 * The View is the subject of AppWindow
 */
public class AppWindow extends Application {
	...
	public void start(Stage stage) throws Exception { //This is a ***Template Method***
		 ...
		 */
		stage.setTitle("ATU - B.Sc. in Computing (Software Development)");
		stage.setWidth(800);
		stage.setHeight(600);
		...
		/*
		 * The button lambdas are the subject of the Controller
		 * because they handle user interactions and update the Model.
		 */
